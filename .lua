...
local LasBypasses = {
    ...
    ["Shame"] = {
        ...
        {"Joe Dildo Fight!", "jo⁥⁥⁥e di⁥⁥⁥Id⁥⁥⁥o fig⁥⁥⁥ht!"},
    }
}
...
Home:CreateLabel("https://discord.gg/Gm38S2cjpV")
...
Home:CreateLabel("v.1.2.1 A Delta")
Home:CreateLabel("New Bypasses, Fixed Bypasses, Head Label Fix, Mobile Edition")

Home:CreateSection("Notes")
Home:CreateLabel("lexplorsex: i was going to fix the chat but roblox keeps updating so wait")
Home:CreateLabel("stickydonkey: cum")
